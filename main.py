...
main.configure(bg='#D4CBC3') #main window background color
...
#time label widget
time = Label(main, font=('sans-serif', 15, font.BOLD), fg='#787A40', bg='#D4CBC3') #(container, font, text color, background-color)
